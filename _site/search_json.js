window.ydoc_plugin_search_json = {
  ...
  "百科全书": [
    ...
    },
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "content": "疯狂改变通常，降低疯狂会让你更稳定。适当提升疯狂，也能让你获取一些额外的好处。疯狂的最小值是0。在0的时候，如果你还降低疯狂，降低的部分就会加到体质上。当你的疯狂到了44后，你每日签到都有可能失败。当你的疯狂超过60之后，每隔4h，你都会干出一点傻事！【走火入魔】千万谨慎！"
        },
        {
          "title": "幸运改变",
    ...
    {
      "title": "婚恋所（暂无）",
      "content": "一般而言，到这儿是为了查看两对修仙情侣的甜蜜指数。除此之外没有别的功能。",
